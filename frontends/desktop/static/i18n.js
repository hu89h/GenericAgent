(() => {
  ...
  zh: {
    ...
    'page.kb.title': '知识库', 'page.kb.sub': '选择知识范围，阅读原文并进行多模态问答',
    'kb.import': '导入', 'kb.build': '构建索引', 'kb.pathPh': '输入包含 Markdown 文档的目录路径', 'kb.add': '开始导入',
    'kb.libraries': '知识库', 'kb.refresh': '刷新', 'kb.backLibraries': '返回知识库', 'kb.backDocs': '返回文档',
    'kb.searchDocs': '搜索文档…', 'kb.open': '打开原件', 'kb.qa': '文档对话', 'kb.qaEmpty': '围绕当前文档提问', 'kb.askPh': '输入问题…', 'kb.citations': '知识库引用', 'kb.openCitation': '打开引用',
    'kb.buildOptionsTitle': '构建索引', 'kb.buildScope': '范围', 'kb.buildAll': '全部知识库', 'kb.buildMode': '模式',
    'kb.buildIncremental': '增量', 'kb.buildRebuild': '重建', 'kb.buildStart': '开始构建',
    ...
    'kb.libraryMeta': '{documents} 个文档 · {images} 张图片', 'kb.document': '文档', 'kb.documentMeta': '{type} · {size}',
    ...
    'err.kbLoad': '加载知识库失败', 'err.kbImport': '导入知识库失败', 'err.kbBuild': '构建索引失败', 'err.kbDelete': '删除知识库失败', 'err.kbAsk': '知识库问答失败',
  ...
  en: {
    ...
    'page.kb.title': 'Knowledge base', 'page.kb.sub': 'Choose a scope, read sources, and ask multimodal questions',
    'kb.import': 'Import', 'kb.build': 'Build index', 'kb.pathPh': 'Directory containing Markdown documents', 'kb.add': 'Start import',
    'kb.libraries': 'Knowledge bases', 'kb.refresh': 'Refresh', 'kb.backLibraries': 'Back to knowledge bases', 'kb.backDocs': 'Back to documents',
    'kb.searchDocs': 'Search documents…', 'kb.open': 'Open source', 'kb.qa': 'Document chat', 'kb.qaEmpty': 'Ask about this document', 'kb.askPh': 'Ask a question…', 'kb.citations': 'Knowledge citations', 'kb.openCitation': 'Open citation',
    'kb.buildOptionsTitle': 'Build index', 'kb.buildScope': 'Scope', 'kb.buildAll': 'All knowledge bases', 'kb.buildMode': 'Mode',
    'kb.buildIncremental': 'Incremental', 'kb.buildRebuild': 'Rebuild', 'kb.buildStart': 'Start build',
    ...
    'kb.libraryMeta': '{documents} documents · {images} images', 'kb.document': 'Document', 'kb.documentMeta': '{type} · {size}',
    ...
    'err.kbLoad': 'Failed to load knowledge base', 'err.kbImport': 'Knowledge-base import failed', 'err.kbBuild': 'Index build failed', 'err.kbDelete': 'Knowledge-base deletion failed', 'err.kbAsk': 'Knowledge-base question failed',

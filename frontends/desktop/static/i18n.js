(() => {
  ...
  zh: {
    ...
    'kb.searchDocs': '搜索文档…', 'kb.open': '打开原件', 'kb.qa': '知识库对话', 'kb.allQa': '全库对话', 'kb.kbQa': '知识库对话', 'kb.docQa': '文档对话', 'kb.qaEmpty': '围绕当前范围提问', 'kb.askPh': '输入问题…', 'kb.citations': '相关图片', 'kb.openCitation': '打开原图',
  ...
  en: {
    ...
    'kb.searchDocs': 'Search documents…', 'kb.open': 'Open source', 'kb.qa': 'Knowledge chat', 'kb.allQa': 'All knowledge chat', 'kb.kbQa': 'Knowledge-base chat', 'kb.docQa': 'Document chat', 'kb.qaEmpty': 'Ask about the current scope', 'kb.askPh': 'Ask a question…', 'kb.citations': 'Related images', 'kb.openCitation': 'Open image',

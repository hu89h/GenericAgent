(() => {
  ...
  zh: {
    ...
    'set.appearance': '外观', 'set.plainUi': '素色', 'set.fontSize': '聊天字号', 'set.lang': '语言', 'set.model': '模型', 'set.addModel': '添加模型', 'set.kbEmbedding': '知识库嵌入', 'set.kbMineru': 'MinerU 文档解析', 'set.kbDimension': '向量维度', 'set.kbParserModel': '解析模型', 'set.kbMineruRegister': '点击注册 MinerU 账号获取 API-Key', 'set.kbKeyConfigured': 'API Key 已配置', 'set.kbKeyMissing': 'API Key 未配置', 'set.kbConfigLoadFailed': '配置加载失败', 'set.kbConfigSaved': '知识库配置已保存', 'set.kbConfigSaveFailed': '知识库配置保存失败', 'set.features': '功能', 'set.importMykey': '导入模型配置', 'set.exportMykey': '导出模型配置', 'set.importMemory': '导入记忆与会话记录', 'set.gaSource': '接入外部 GenericAgent 源码', 'set.gaSourceClear': '改用内置版本', 'set.gaSourceCurrent': '当前接入', 'set.serviceManager': '后台服务管理',
    ...
    'kb.searchDocs': '搜索文档…', 'kb.open': '打开原件', 'kb.qa': '知识库对话', 'kb.allQa': '全库对话', 'kb.kbQa': '知识库对话', 'kb.docQa': '文档对话', 'kb.qaEmpty': '围绕当前范围提问', 'kb.askPh': '输入问题…', 'kb.citations': '知识库引用', 'kb.openCitation': '打开引用',
    'kb.buildOptionsTitle': '构建索引', 'kb.buildScope': '范围', 'kb.buildAll': '全部知识库', 'kb.buildMode': '模式',
    'kb.buildIncremental': '增量', 'kb.buildIncrementalDesc': '只处理新增或发生变化的内容', 'kb.buildRebuild': '重建', 'kb.buildRebuildDesc': '重新生成当前范围的全部索引', 'kb.buildStart': '开始构建',
    'kb.noData': '暂无知识库', 'kb.noDocs': '暂无已导入文档', 'kb.loading': '加载中…', 'kb.ready': '已就绪', 'kb.notReady': '未就绪',
    ...
    'kb.libraryMeta': '{documents} 个文档 · {images} 张图片', 'kb.document': '文档', 'kb.documentMeta': '{type} · {size}', 'kb.originalUnavailable': '原始文件不可用', 'kb.previewUnavailable': '当前文件类型无法在应用内预览，请点击“打开原件”查看',
    'kb.phase.queued': '等待开始', 'kb.phase.scanning': '正在检查文件', 'kb.phase.preparing': '正在准备文档', 'kb.phase.processing': '正在解析文档',
    'kb.phase.indexing': '正在构建检索索引', 'kb.phase.completed': '处理完成', 'kb.phase.completedWithFailures': '处理完成，部分文件失败', 'kb.phase.failed': '处理失败',
    'kb.importCounts': '已处理 {completed}/{total} 个文档 · 成功 {success} · 失败 {failure}',
    'kb.importExtras': '保留 {assets} 张正文图片 · 忽略 {ignored} 个无关文件',
    'kb.buildCounts': '已处理 {completed}/{total} 个知识库 · 成功 {success} · 失败 {failure}',
    'kb.partProgress': '第 {current}/{total} 部分', 'kb.successList': '成功项', 'kb.failureList': '失败项',
    'kb.error.api_key_missing': '请先在设置中配置 MinerU API-Key',
    'kb.error.page_limit': '文档页数超出服务限制，自动分片仍未能完成处理',
  ...
  en: {
    ...
    'set.appearance': 'Appearance', 'set.plainUi': 'Plain', 'set.fontSize': 'Chat font size', 'set.lang': 'Language', 'set.model': 'Model', 'set.addModel': 'Add model', 'set.kbEmbedding': 'Knowledge-base embeddings', 'set.kbMineru': 'MinerU document parser', 'set.kbDimension': 'Vector dimension', 'set.kbParserModel': 'Parser model', 'set.kbMineruRegister': 'Register a MinerU account to get an API key', 'set.kbKeyConfigured': 'API key configured', 'set.kbKeyMissing': 'API key not configured', 'set.kbConfigLoadFailed': 'Failed to load configuration', 'set.kbConfigSaved': 'Knowledge-base configuration saved', 'set.kbConfigSaveFailed': 'Failed to save knowledge-base configuration', 'set.features': 'Features', 'set.importMykey': 'Import model config', 'set.exportMykey': 'Export model config', 'set.importMemory': 'Import memory and sessions', 'set.gaSource': 'Connect external GenericAgent source', 'set.gaSourceClear': 'Use bundled version', 'set.gaSourceCurrent': 'Connected to', 'set.serviceManager': 'Service manager',
    ...
    'kb.import': 'Import', 'kb.build': 'Build index',
    ...
    'kb.searchDocs': 'Search documents…', 'kb.open': 'Open source', 'kb.qa': 'Knowledge chat', 'kb.allQa': 'All knowledge chat', 'kb.kbQa': 'Knowledge-base chat', 'kb.docQa': 'Document chat', 'kb.qaEmpty': 'Ask about the current scope', 'kb.askPh': 'Ask a question…', 'kb.citations': 'Knowledge citations', 'kb.openCitation': 'Open citation',
    'kb.buildOptionsTitle': 'Build index', 'kb.buildScope': 'Scope', 'kb.buildAll': 'All knowledge bases', 'kb.buildMode': 'Mode',
    'kb.buildIncremental': 'Incremental', 'kb.buildIncrementalDesc': 'Process only new or changed content', 'kb.buildRebuild': 'Rebuild', 'kb.buildRebuildDesc': 'Regenerate the full index for this scope', 'kb.buildStart': 'Start build',
    'kb.noData': 'No knowledge bases', 'kb.noDocs': 'No imported documents', 'kb.loading': 'Loading…', 'kb.ready': 'Ready', 'kb.notReady': 'Not ready',
    ...
    'kb.libraryMeta': '{documents} documents · {images} images', 'kb.document': 'Document', 'kb.documentMeta': '{type} · {size}', 'kb.originalUnavailable': 'The original file is unavailable', 'kb.previewUnavailable': 'This file type cannot be previewed here. Click “Open source” to view it',
    ...
    'kb.phase.indexing': 'Building the search index', 'kb.phase.completed': 'Completed', 'kb.phase.completedWithFailures': 'Completed with some failures', 'kb.phase.failed': 'Processing failed',
    'kb.importCounts': 'Processed {completed}/{total} documents · {success} succeeded · {failure} failed',
    ...
    'kb.partProgress': 'Part {current}/{total}', 'kb.successList': 'Succeeded', 'kb.failureList': 'Failed',
    'kb.error.api_key_missing': 'Configure the MinerU API key in Settings first',
    'kb.error.page_limit': 'The document still exceeded the service page limit after automatic splitting',

(() => {
  ...
  zh: {
    ...
    'set.kbEmbedding': '知识库嵌入模型', 'set.kbMineru': 'MinerU 文档解析', 'set.kbDimension': '向量维度', 'set.kbParserModel': '解析模型', 'set.kbMineruRegister': '注册 MinerU 账号并获取 API Key', 'set.kbKeyConfigured': 'API Key 已配置', 'set.kbKeyMissing': 'API Key 未配置', 'set.kbConfigLoadFailed': '配置加载失败', 'set.kbConfigSaved': '知识库配置已保存', 'set.kbConfigSaveFailed': '知识库配置保存失败',
    ...
    'model.vision': '支持图片输入', 'model.visionHint': '保存时会发送一次真实视觉自测', 'model.visionBadge': '支持多模态',
    ...
    'pq.title': '配置向导', 'pq.sub': '先配置对话模型，再按需启用知识库', 'pq.toggle': '展开 / 收起',
    'pq.modelTitle': '配置对话模型',
    'pq.qwenName': '通义千问', 'pq.deepseekName': 'DeepSeek', 'pq.recommended': '推荐',
    'pq.deepseekDesc': '可切换 · OpenAI 兼容 · 纯文本模型', 'pq.qwenDesc': '阿里云百炼 · 推荐多模态',
    'pq.embeddingTitle': '配置嵌入模型',
    'pq.embeddingAction': '嵌入模型', 'pq.embeddingActionDesc': '用于知识库语义检索；不使用知识库可忽略此项',
    'pq.mineruTitle': '配置 MinerU',
    'pq.mineruAction': 'MinerU', 'pq.mineruActionDesc': '用于解析 PDF/Office；不使用知识库可忽略此项',
    'pq.configured': '已配置', 'pq.toConfigure': '待配置',
    'pq.embeddingModalTitle': '配置嵌入模型', 'pq.embeddingGuide1': '嵌入模型把文本转换为向量，知识库才能进行语义检索。', 'pq.embeddingGuide2': '如果已配置阿里云百炼模型，API Key 可以留空并自动复用。当前默认值已填入阿里云配置。', 'pq.embeddingGuide3': '默认使用 text-embedding-v4 / 1024 维，通常无需修改。', 'pq.embeddingGuideTip': '保存后即可在导入知识库时使用；不使用知识库可跳过此项。',
    'pq.mineruModalTitle': '配置 MinerU', 'pq.mineruGuide1': 'MinerU 负责把 PDF/Office 文档解析成可检索内容。', 'pq.mineruGuide2': '注册 MinerU 账号并获取 API Key。', 'pq.mineruGuide3': '填写 Key 后保存，再从知识库页面导入文档。', 'pq.mineruRegister': '注册并获取 MinerU API Key', 'pq.mineruGuideTip': '解析服务由 MinerU 提供，源文档不会被修改；不使用知识库可跳过此项。',
    ...
    'err.modelSave': '保存失败', 'err.modelSwitch': '切换模型失败', 'err.modelRequired': '请填写模型、API Key 和 API 地址', 'err.visionProbe': '视觉自测失败，未保存模型配置', 'err.visionRequired': '当前模型未验证图片能力，请切换模型或在设置中保存并验证',
    ...
    'page.kb.title': '知识库',
    'kb.import': '添加文档', 'kb.importFolder': '导入文件夹', 'kb.create': '新建知识库', 'kb.createTitle': '新建知识库', 'kb.createName': '知识库名称', 'kb.createHint': '先创建一个空知识库，再添加一个或多个文档。', 'kb.createStart': '创建', 'kb.build': '重建索引', 'kb.importResult': '导入结果', 'kb.reindexResult': '重建结果',
    'kb.libraries': '知识库', 'kb.refresh': '刷新', 'kb.backLibraries': '返回知识库', 'kb.backDocs': '返回文档',
    'kb.choose': '选择知识范围', 'kb.settings': '知识库设置', 'kb.chooseDocument': '选择文档', 'kb.disabled': '不使用知识库', 'kb.allInKb': '全部文档', 'kb.scopeAll': '全部知识库', 'kb.scopeKb': '知识库', 'kb.scopeDoc': '文档', 'kb.noReady': '没有已构建的知识库',
    'kb.searchDocs': '搜索文档…', 'kb.searchKbs': '搜索知识库…', 'kb.selectedDocuments': '个文档', 'kb.selectedKbs': '个知识库', 'kb.open': '打开原件', 'kb.qa': '知识库对话', 'kb.allQa': '全库对话', 'kb.kbQa': '知识库对话', 'kb.docQa': '文档对话', 'kb.qaEmpty': '围绕当前范围提问', 'kb.askPh': '输入问题…', 'kb.citations': '相关图片', 'kb.openCitation': '打开原图', 'kb.collapseBrowser': '收起知识库和文档栏', 'kb.expandBrowser': '展开知识库和文档栏', 'kb.collapseQa': '收起知识库对话栏', 'kb.expandQa': '展开知识库对话栏',
    'kb.buildOptionsTitle': '重建索引', 'kb.buildScope': '知识库', 'kb.buildStart': '开始重建', 'kb.reindexDesc': '使用已导入的统一图文记录重新生成完整索引，不重复运行 MinerU 或图片分析。',
    'kb.noData': '暂无知识库', 'kb.noDocs': '暂无已导入文档', 'kb.image': '图片', 'kb.loading': '加载中…', 'kb.ready': '已就绪', 'kb.notReady': '未就绪',
    'kb.delete': '删除', 'kb.deleteConfirm': '确定删除这个知识库及其索引吗？', 'kb.importing': '正在导入', 'kb.building': '正在构建',
    'kb.completed': '已完成', 'kb.importSuccess': '导入成功', 'kb.importFailure': '导入失败', 'kb.counts': '成功 {success} · 失败 {failure}',
    'kb.libraryMeta': '{documents} 个文档 · {images} 张图片', 'kb.document': '文档', 'kb.documentMeta': '{type} · {size}', 'kb.originalUnavailable': '原始文件不可用', 'kb.previewUnavailable': '当前文件类型无法在应用内预览，请点击“打开原件”查看', 'kb.openExternalHint': '文档内容由知识库工具读取；如需查看原始文件，请点击“打开原件”。',
    ...
    'kb.runInBackground': '收起到后台', 'kb.cancelTask': '中断任务', 'kb.cancellingTask': '正在中断…', 'kb.cancelTaskConfirm': '确定中断当前任务吗？尚未发布的处理结果会被清理，已有知识库不受影响。', 'kb.cancelTaskError': '无法中断任务', 'kb.taskMonitorRetrying': '暂时无法获取进度，正在重试', 'kb.taskCapsuleImport': '知识库导入', 'kb.taskCapsuleReindex': '知识库重建',
    ...
    'kb.error.processing_failed': '处理失败，请检查文件后重试',
    'kb.error.kb_job_not_found': '任务记录已失效，可能是应用服务已重启',
    'err.kbLoad': '加载知识库失败', 'err.kbImport': '导入知识库失败', 'err.kbFolderPicker': '当前环境不支持文件夹选择，请使用桌面版打开', 'err.kbFilePicker': '当前环境不支持文件选择，请使用桌面版打开', 'err.kbCreate': '新建知识库失败', 'err.kbNoSelection': '请先选择一个知识库', 'err.kbBuild': '构建索引失败', 'err.kbDelete': '删除知识库失败', 'err.kbAsk': '知识库问答失败',
  ...
  en: {
    ...
    'set.kbEmbedding': 'Knowledge-base embedding model', 'set.kbMineru': 'MinerU document parser', 'set.kbDimension': 'Vector dimension', 'set.kbParserModel': 'Parser model', 'set.kbMineruRegister': 'Register a MinerU account and get an API key', 'set.kbKeyConfigured': 'API key configured', 'set.kbKeyMissing': 'API key not configured', 'set.kbConfigLoadFailed': 'Failed to load configuration', 'set.kbConfigSaved': 'Knowledge-base configuration saved', 'set.kbConfigSaveFailed': 'Failed to save knowledge-base configuration',
    ...
    'model.vision': 'Image input', 'model.visionHint': 'Saving runs one real visual capability check', 'model.visionBadge': 'Multimodal support',
    ...
    'pq.title': 'Setup guide', 'pq.sub': 'Set up chat first, then enable the knowledge base if needed', 'pq.toggle': 'Expand / collapse',
    'pq.modelTitle': 'Set up a chat model',
    'pq.qwenName': 'Tongyi Qwen', 'pq.deepseekName': 'DeepSeek', 'pq.recommended': 'Recommended',
    'pq.deepseekDesc': 'Alternative · OpenAI-compatible · Text only', 'pq.qwenDesc': 'Aliyun Bailian · Multimodal',
    'pq.embeddingTitle': 'Set up embeddings',
    'pq.embeddingAction': 'Embedding model', 'pq.embeddingActionDesc': 'Powers semantic KB search; skip this if you do not use the knowledge base',
    'pq.mineruTitle': 'Set up MinerU',
    'pq.mineruAction': 'MinerU', 'pq.mineruActionDesc': 'Parses PDF/Office files; skip this if you do not use the knowledge base',
    'pq.configured': 'Configured', 'pq.toConfigure': 'Not configured',
    'pq.embeddingModalTitle': 'Configure embedding model', 'pq.embeddingGuide1': 'Embedding model turn text into vectors so the knowledge base can search semantically.', 'pq.embeddingGuide2': 'If an Aliyun Bailian model is configured, leave the API key blank to reuse it automatically. The current defaults are filled from the Aliyun configuration.', 'pq.embeddingGuide3': 'text-embedding-v4 / 1024 dimensions is the default and usually needs no change.', 'pq.embeddingGuideTip': 'Save this configuration before importing a knowledge base; skip it if you do not use the knowledge base.',
    'pq.mineruModalTitle': 'Configure MinerU', 'pq.mineruGuide1': 'MinerU parses PDF/Office files into searchable content.', 'pq.mineruGuide2': 'Register a MinerU account and obtain an API key.', 'pq.mineruGuide3': 'Save the key, then import documents from the knowledge-base page.', 'pq.mineruRegister': 'Register and get a MinerU API key', 'pq.mineruGuideTip': 'Parsing is provided by MinerU; source documents are not modified. Skip it if you do not use the knowledge base.',
    ...
    'err.modelSave': 'Save failed', 'err.modelSwitch': 'Failed to switch model', 'err.modelRequired': 'Model, API Key and base URL are required', 'err.visionProbe': 'Visual capability check failed; model was not saved', 'err.visionRequired': 'The current model is not verified for image input. Switch models or verify it in settings',
    ...
    'kb.import': 'Add documents', 'kb.importFolder': 'Import folder', 'kb.create': 'New knowledge base', 'kb.createTitle': 'New knowledge base', 'kb.createName': 'Knowledge-base name', 'kb.createHint': 'Create an empty knowledge base first, then add one or more documents.', 'kb.createStart': 'Create', 'kb.build': 'Reindex', 'kb.importResult': 'Import result', 'kb.reindexResult': 'Reindex result',
    'kb.libraries': 'Knowledge bases', 'kb.refresh': 'Refresh', 'kb.backLibraries': 'Back to knowledge bases', 'kb.backDocs': 'Back to documents',
    'kb.choose': 'Choose knowledge scope', 'kb.settings': 'Knowledge settings', 'kb.chooseDocument': 'Choose document', 'kb.disabled': 'Do not use knowledge bases', 'kb.allInKb': 'All documents', 'kb.scopeAll': 'All knowledge bases', 'kb.scopeKb': 'Knowledge base', 'kb.scopeDoc': 'Document', 'kb.noReady': 'No ready knowledge base is available',
    'kb.searchDocs': 'Search documents…', 'kb.searchKbs': 'Search knowledge bases…', 'kb.selectedDocuments': 'documents', 'kb.selectedKbs': 'knowledge bases', 'kb.open': 'Open source', 'kb.qa': 'Knowledge chat', 'kb.allQa': 'All knowledge chat', 'kb.kbQa': 'Knowledge-base chat', 'kb.docQa': 'Document chat', 'kb.qaEmpty': 'Ask about the current scope', 'kb.askPh': 'Ask a question…', 'kb.citations': 'Related images', 'kb.openCitation': 'Open image', 'kb.collapseBrowser': 'Collapse knowledge and document panel', 'kb.expandBrowser': 'Expand knowledge and document panel', 'kb.collapseQa': 'Collapse knowledge chat panel', 'kb.expandQa': 'Expand knowledge chat panel',
    'kb.buildOptionsTitle': 'Reindex', 'kb.buildScope': 'Knowledge base', 'kb.buildStart': 'Start reindex', 'kb.reindexDesc': 'Regenerate the complete index from persisted text and image records without rerunning MinerU or image analysis.',
    'kb.noData': 'No knowledge bases', 'kb.noDocs': 'No imported documents', 'kb.image': 'Image', 'kb.loading': 'Loading…', 'kb.ready': 'Ready', 'kb.notReady': 'Not ready',
    'kb.delete': 'Delete', 'kb.deleteConfirm': 'Delete this knowledge base and its index?', 'kb.importing': 'Importing', 'kb.building': 'Building',
    ...
    'kb.libraryMeta': '{documents} documents · {images} images', 'kb.document': 'Document', 'kb.documentMeta': '{type} · {size}', 'kb.originalUnavailable': 'The original file is unavailable', 'kb.previewUnavailable': 'This file type cannot be previewed here. Click “Open source” to view it', 'kb.openExternalHint': 'Document content is read through knowledge tools. Click “Open source” to inspect the original file.',

(() => {
  ...
  zh: {
    ...
    'model.vision': '支持图片输入', 'model.visionHint': '保存时会发送一次真实视觉自测', 'model.visionBadge': '已验证支持图片',
  ...
  en: {
    ...
    'model.vision': 'Image input', 'model.visionHint': 'Saving runs one real visual capability check', 'model.visionBadge': 'Verified image input',

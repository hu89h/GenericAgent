(() => {
  ...
  zh: {
    ...
    'kb.choose': '选择知识范围', 'kb.disabled': '不使用知识库', 'kb.allInKb': '全部文档', 'kb.scopeAll': '全部知识库', 'kb.scopeKb': '知识库', 'kb.scopeDoc': '文档', 'kb.noReady': '没有已构建的知识库',
  ...
  en: {
    ...
    'kb.choose': 'Choose knowledge scope', 'kb.disabled': 'Do not use knowledge bases', 'kb.allInKb': 'All documents', 'kb.scopeAll': 'All knowledge bases', 'kb.scopeKb': 'Knowledge base', 'kb.scopeDoc': 'Document', 'kb.noReady': 'No ready knowledge base is available',
